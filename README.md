...
Windows: [![AppVeyor](https://ci.appveyor.com/api/projects/status/github/conda-forge/loompy-feedstock?svg=True)](https://ci.appveyor.com/project/conda-forge/loompy-feedstock/branch/master)
...
Once the `conda-forge` channel has been enabled, `loompy` can be installed with:

```
conda install loompy
```

It is possible to list all of the versions of `loompy` available on your platform with:
